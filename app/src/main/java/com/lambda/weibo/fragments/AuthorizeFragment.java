 ...
 * {@link AuthorizeFragment.OnFragmentInteractionListener} interface
...
public class AuthorizeFragment extends Fragment {
    ...
    public void onStart() {
        ...
        final WebView view = (WebView) activity.findViewById(R.id.authorize_view);
        view.getSettings().setJavaScriptEnabled(true);
        view.setWebViewClient(new WebViewClient() {
            @Override
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if (url.contains(MainActivity.REDIRECT_URL)) {
        ...
        String url = AuthorizeUri.authorize(MainActivity.APP_KEY, MainActivity.REDIRECT_URL);
        view.loadUrl(url);
    }
